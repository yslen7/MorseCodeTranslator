...
cuadrotiempo["values"]=[5,10,15,20,25,30,35]
cuadrotiempo.place(x=130,y=166)

labeltiempo=Label(frameS,text="Tiempo de grabación:",font=("Arial Narrow",12))
labeltiempo.place(x=45,y=140)
labeltiempo.config(bg="blue")


#----------------- TEXTO DE RESPUESTA--------------------------
labelA=Label(frameS,text="Su mensaje dice:",font=("Arial Narrow",10))
...
#------------------ BOTON-------------------------------------
Bbuscar=Button(frameS,text="GRABAR", command=Iniciar)
Bbuscar.pack()
